    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Account",
                columns: new[] { "AccountId", "BirthDate", "FirstName", "Gender", "LastName", "Password", "Role", "Username" },
                values: new object[] { 1, new DateTime(2023, 5, 2, 19, 19, 15, 964, DateTimeKind.Local).AddTicks(5042), "user", 1, "user", "test", 2, "user" });

            migrationBuilder.InsertData(
                table: "Employee",
                columns: new[] { "EmployeeId", "BirthDate", "FirstName", "Gender", "LastName", "Password", "Role", "Username" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 5, 2, 19, 19, 15, 964, DateTimeKind.Local).AddTicks(5172), "desktop", 1, "desktop", "test", 0, "desktop" },
                    { 2, new DateTime(2023, 5, 2, 19, 19, 15, 964, DateTimeKind.Local).AddTicks(5176), "mobile", 1, "mobile", "test", 0, "mobile" },
                    { 3, new DateTime(2023, 5, 2, 19, 19, 15, 964, DateTimeKind.Local).AddTicks(5178), "employee", 1, "employee", "test", 1, "employee" }
                });
